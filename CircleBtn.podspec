#
#  Be sure to run `pod spec lint CircleBtn.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "yaolinhong" => "768805503@qq.com" }
  # Or just: s.author    = "yaolinhong"
  # s.authors            = { "yaolinhong" => "768805503@qq.com" }
  # s.social_media_url   = "http://twitter.com/yaolinhong"
